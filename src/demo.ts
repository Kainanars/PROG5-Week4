...
const task1 = taskService.createTask(
  'Desenvolver Capstone PROG5',
  'Estudar conceitos básicos de TypeScript para implementar o Capstone PROG5',
  new Date('2025-01-29')
);
const task2 = taskService.createTask(
  'Fazer exercício de POO',
  'Criar um exemplo de CRUD utilizando POO',
  new Date('2025-01-28')
);
